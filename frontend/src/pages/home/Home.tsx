    ...
    return (
        <div className="relative w-screen h-screen bg-dot">
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-center bg-transparent">
                ...
                <button onClick={handleStart} className="cursor-pointer text-white text-[24px] font-inter-semibold px-12 py-3 border-2 border-white rounded-2xl bg-black">Start</button>
            </div>
        </div>
    )
}
